  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="/PHPEX/26_form.php">Home</a>
        </li>
        <li class="nav-item">
...
<strong>Error!</strong>We are Facing some technical issue.Your entry was not submitted successfully!
We regrate for inconvenince!!
<button type="button" class="close" data-dismiss="alert" aria-label="Close">
  <span aria-hidden="true">&times;</span>
</button>
</div>';
...
<form  action="/PHPEX/26_form.php" method="post">
  <div class="form-group">
    <label for="name">Name</label>
    <input type="text" name="name" class="form-control" id="name" aria-describedby="emailHelp" placeholder="Enter name">
    <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your N with anyone else.</small> -->
  </div>
  <div class="form-group">
